...
public class LivroService {
	...
	public Page<LivroVO> pesquisaTodos(Pageable pageable) {
		var page = repositorio.findAll(pageable);
		return page.map(this::converterParaLivroVO);
	}
	
	private LivroVO converterParaLivroVO(Livro livro) {
		return DozerConverter.parserObjeto(livro, LivroVO.class);
	}
}
